...
class AddProductBatchWidget(object):
    def setupUi(self, Dialog):
        ...
        self.recorder = QtWidgets.QLineEdit(Dialog)
        ...
        self.recordDate = QtWidgets.QLineEdit(Dialog)
        self.recordDate.setObjectName("recordDate")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.recordDate)
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.deliverer)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.receiveCompany)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.receiver)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.deliverDate)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.Label_2.setText(_translate("Dialog", "登记人："))
        self.Label_3.setText(_translate("Dialog", "登记日期："))
    ...
    def updateData(self, list, queryModel):
        ...
        self.deliverDate.setText(list[3])
