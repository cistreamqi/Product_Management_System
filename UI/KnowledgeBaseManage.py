...
class KnowledgeBaseManage(MySearchWidget):
    ...
    def retranslateUi(self, Form):
        ...
        self.addBatchButton.setText(_translate("Form", "新增知识分类"))
        self.selectProduct.setText(_translate("Form", "查看知识分类"))
        self.alterVBatchButton.setText(_translate("Form", "修改知识分类"))
        self.deleteBatchButton.setText(_translate("Form", "删除知识分类"))
        self.searchButton.setText(_translate("Form", "查询"))
        self.comboBox.setItemText(0, _translate("Form", "按序号查询"))
        self.comboBox.setItemText(1, _translate("Form", "按数据项查询"))
        self.comboBox.setItemText(2, _translate("Form", "按数据类型查询"))
